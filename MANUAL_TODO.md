...
| 6 | `s06` | *TBD — S7 fills this in* | **queued** |
...
# S6 — the API. S7 replaces this with the literal SHA.
git tag -a s06 "$(git rev-list -1 --grep='^Merge S6 into main' origin/main)" -m "S6: API"
