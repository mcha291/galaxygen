...
_ADAMS13_READ = (
    ...
    "at S30 by a read-only agent and confirmed by a second fetch [verified: arXiv:1306.0559]: 'Based "
    "on our modeled observability, we find a Galactic core-collapse supernova rate of 3.2 +7.3 -2.6 "
    "per century and a Galactic Type Ia supernova rate of 1.4 +1.4 -0.8 per century' (a total of "
    "4.6 +7.4 -2.7), from 'the magnitude distribution of Galactic SNe ... together with historical "
    "SNe'. The window is the source's asymmetric interval converted to per year, nothing chosen "
